...
export async function registerRoutes(_httpServer: Server, app: Express) {
  ...
  const questionSeeds: Array<{
    ...
    { key: "chiefComplaint", sectionKey: "vitals", label: "Chief Complaint", inputType: "textarea", enabled: 1, required: 0, displayOrder: 1000, isBuiltin: 1, optionsJson: null },
    { key: "temperature", sectionKey: "vitals", label: "Temperature", inputType: "number", enabled: 1, required: 0, displayOrder: 2000, isBuiltin: 1, optionsJson: null },
    { key: "heartRate", sectionKey: "vitals", label: "Heart Rate", inputType: "number", enabled: 1, required: 0, displayOrder: 3000, isBuiltin: 1, optionsJson: null },
    { key: "respiratoryRate", sectionKey: "vitals", label: "Respiration", inputType: "number", enabled: 1, required: 0, displayOrder: 4000, isBuiltin: 1, optionsJson: null },
    { key: "crt", sectionKey: "vitals", label: "CRT", inputType: "text", enabled: 1, required: 0, displayOrder: 5000, isBuiltin: 1, optionsJson: null },
    { key: "dehydrationPercentage", sectionKey: "vitals", label: "Dehydration percentage", inputType: "number", enabled: 1, required: 0, displayOrder: 6000, isBuiltin: 1, optionsJson: null },
    { key: "rumenMotility", sectionKey: "vitals", label: "Rumen Motility", inputType: "text", enabled: 1, required: 0, displayOrder: 7000, isBuiltin: 1, optionsJson: null },
    { key: "weight", sectionKey: "vitals", label: "Weight", inputType: "number", enabled: 1, required: 0, displayOrder: 8000, isBuiltin: 1, optionsJson: null },
    { key: "colour", sectionKey: "vitals", label: "Colour", inputType: "text", enabled: 1, required: 0, displayOrder: 9000, isBuiltin: 1, optionsJson: null },
    {
      key: "testsSuggested",
